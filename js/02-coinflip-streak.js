...
// variables, do while loops, conditionals, operators, math, and more to create a 
// “coin flip streak game”. The point of this simple game is to see what kind of 
// streak you can get to (how many times “Heads” comes up in a row before “Tails” 
// does to end the game). To complete the game follow the steps outlined below:

// Begin your application by declaring a variable called coinFlip. Do not assign
// the variable a number just yet.
// Create a do while loop.
// Within the do while loop assign a randomly generated number to coinFlip.
// You will have to use the same Math formula you used in previous assignment.
